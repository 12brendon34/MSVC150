...
:: Point to SDK bundled alongside the VS install instead of registry lookup
...
set PATH=%~dp0..\..\Common7\IDE;%~dp0..\..\VC\BIN;%~dp0..\..\Common7\Tools;%PATH%
set INCLUDE=%~dp0..\..\VC\ATLMFC\INCLUDE;%~dp0..\..\VC\INCLUDE;%INCLUDE%
set LIB=%~dp0..\..\VC\ATLMFC\LIB;%~dp0..\..\VC\LIB;%LIB%
set LIBPATH=%~dp0..\..\VC\ATLMFC\LIB;%~dp0..\..\VC\LIB;%LIBPATH%
